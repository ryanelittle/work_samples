...
These code samples have been chosen to show my growth as a computational journalist since first learning the basics of the Tidyverse in August 2019.
...
This code was written as part of a collaboration between the Howard Center for Investigative Journalism and [BigLocalNews](https://biglocalnews.org/#/login) to write a generic court-scraper that supports the most common court website platforms. 
...
This analysis also created a searchable database that informed my on-the-ground reporting. On a reporting trip just as the pandemic was descending upon the country, I was able to search criminal histories as I met individual homeless people.
